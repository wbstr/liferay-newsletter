...
/**
 * The utility for the newsletter local service. This utility wraps {@link com.wcs.newsletter.service.impl.NewsletterLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.wcs.newsletter.service.base.NewsletterLocalServiceBaseImpl
 * @see com.wcs.newsletter.service.impl.NewsletterLocalServiceImpl
 * @generated
 */
public class NewsletterLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.wcs.newsletter.service.impl.NewsletterLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.wcs.newsletter.model.Newsletter addNewsletter(
    ...
    */
    public static com.wcs.newsletter.model.Newsletter createNewsletter(
        long newsletterId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Newsletter deleteNewsletter(
        long newsletterId)
    ...
    */
    ...
    public static com.wcs.newsletter.model.Newsletter fetchNewsletter(
        long newsletterId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Newsletter getNewsletter(
        long newsletterId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.wcs.newsletter.model.Newsletter> getNewsletters(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Newsletter updateNewsletter(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    public static com.wcs.newsletter.model.Newsletter updateNewsletter(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateNewsletter(newsletter, merge);
    }
    ...
    */
    ...
    public static java.util.List<com.wcs.newsletter.model.Category> getCategories(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCategories(newsletter);
    }

    public static java.util.List<com.wcs.newsletter.model.Recipient> getRecipients(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getRecipients(newsletter);
    }

    public static java.util.List<com.wcs.newsletter.model.Label> getLabels(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getLabels(newsletter);
    }

    public static com.wcs.newsletter.model.Newsletter save(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().save(newsletter);
    }

    public static com.wcs.newsletter.model.Newsletter saveChild(
        com.wcs.newsletter.model.Newsletter newsletter)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().saveChild(newsletter);
    }
