...
/**
 * The base implementation of the newsletter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.wcs.newsletter.service.impl.NewsletterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.wcs.newsletter.service.impl.NewsletterLocalServiceImpl
 * @see com.wcs.newsletter.service.NewsletterLocalServiceUtil
 * @generated
 */
public abstract class NewsletterLocalServiceBaseImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.wcs.newsletter.service.NewsletterLocalServiceUtil} to access the newsletter local service.
     */
    ...
    public Newsletter addNewsletter(Newsletter newsletter)
        ...
        return newsletterPersistence.update(newsletter, false);
    }
    ...
    public Newsletter updateNewsletter(Newsletter newsletter)
        throws SystemException {
        return updateNewsletter(newsletter, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Newsletter updateNewsletter(Newsletter newsletter, boolean merge)
        throws SystemException {
        newsletter.setNew(false);

        return newsletterPersistence.update(newsletter, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.wcs.newsletter.model.Newsletter",
