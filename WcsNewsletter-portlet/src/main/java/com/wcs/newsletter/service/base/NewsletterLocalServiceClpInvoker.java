...
public class NewsletterLocalServiceClpInvoker {
    ...
    public NewsletterLocalServiceClpInvoker() {
        ...
        _methodParameterTypes0 = new String[] {
                "com.wcs.newsletter.model.Newsletter"
            };
        ...
        _methodName9 = "fetchNewsletter";

        _methodParameterTypes9 = new String[] { "long" };

        _methodName10 = "getNewsletter";
        ...
        _methodName12 = "getNewsletters";

        _methodParameterTypes12 = new String[] { "int", "int" };

        _methodName13 = "getNewslettersCount";

        _methodParameterTypes13 = new String[] {  };

        _methodName14 = "updateNewsletter";
        ...
        _methodParameterTypes15 = new String[] {
                "com.wcs.newsletter.model.Newsletter", "boolean"
            };
        ...
        _methodName68 = "getRecipients";

        _methodParameterTypes68 = new String[] {
                "com.wcs.newsletter.model.Newsletter"
            };

        _methodName69 = "getLabels";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return NewsletterLocalServiceUtil.addNewsletter((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return NewsletterLocalServiceUtil.deleteNewsletter((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }
        ...
        if (_methodName14.equals(name) &&
            ...
            return NewsletterLocalServiceUtil.updateNewsletter((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }
        ...
        if (_methodName66.equals(name) &&
            ...
            return NewsletterLocalServiceUtil.findByParentId(((Long) arguments[0]).longValue());
        }

        if (_methodName67.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes67, parameterTypes)) {
            return NewsletterLocalServiceUtil.getCategories((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }

        if (_methodName68.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes68, parameterTypes)) {
            return NewsletterLocalServiceUtil.getRecipients((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }

        if (_methodName69.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes69, parameterTypes)) {
            return NewsletterLocalServiceUtil.getLabels((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }

        if (_methodName70.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes70, parameterTypes)) {
            return NewsletterLocalServiceUtil.save((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }

        if (_methodName71.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes71, parameterTypes)) {
            return NewsletterLocalServiceUtil.saveChild((com.wcs.newsletter.model.Newsletter) arguments[0]);
        }
