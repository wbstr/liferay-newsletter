...
public class SubscriptionCategoryLocalServiceClp
    ...
    public SubscriptionCategoryLocalServiceClp(
        ...
        _methodName19 = "findBySubscriptionId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "findByConfirmationKey";

        _methodParameterTypes20 = new String[] { "java.lang.String" };

        _methodName21 = "findByCancellationKey";
        ...
        _methodName23 = "findByCategoryId";
    ...
    public com.wcs.newsletter.model.SubscriptionCategory addSubscriptionCategory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(subscriptionCategory)
                    });
        } catch (Throwable t) {
        ...
        return (com.wcs.newsletter.model.SubscriptionCategory) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.wcs.newsletter.model.SubscriptionCategory createSubscriptionCategory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(subscriptionCategoryPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.wcs.newsletter.model.SubscriptionCategory> getSubscriptionCategories(
        ...
        return (java.util.List<com.wcs.newsletter.model.SubscriptionCategory>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.wcs.newsletter.model.SubscriptionCategory> findBySubscriptionId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { subscriptionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.wcs.newsletter.model.SubscriptionCategory> findByConfirmationKey(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    ...
                    new Object[] { ClpSerializer.translateInput(confirmationKey) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.wcs.newsletter.model.SubscriptionCategory> findByCancellationKey(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] { ClpSerializer.translateInput(cancellationKey) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
