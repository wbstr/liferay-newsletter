...
/**
 * The utility for the recipient local service. This utility wraps {@link com.wcs.newsletter.service.impl.RecipientLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class RecipientLocalServiceUtil {
    private static RecipientLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.wcs.newsletter.service.impl.RecipientLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.wcs.newsletter.model.Recipient addRecipient(
        com.wcs.newsletter.model.Recipient recipient)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addRecipient(recipient);
    }
    ...
    */
    public static com.wcs.newsletter.model.Recipient createRecipient(
        long recipientId) {
        return getService().createRecipient(recipientId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Recipient deleteRecipient(
        long recipientId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteRecipient(recipientId);
    }
    ...
    */
    public static com.wcs.newsletter.model.Recipient deleteRecipient(
        com.wcs.newsletter.model.Recipient recipient)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteRecipient(recipient);
    }
    ...
    */
    ...
    public static com.wcs.newsletter.model.Recipient fetchRecipient(
        long recipientId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchRecipient(recipientId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Recipient getRecipient(
        long recipientId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getRecipient(recipientId);
    }
    ...
    */
    public static java.util.List<com.wcs.newsletter.model.Recipient> getRecipients(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getRecipients(start, end);
    }
    ...
    */
    public static int getRecipientsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getRecipientsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.wcs.newsletter.model.Recipient updateRecipient(
        com.wcs.newsletter.model.Recipient recipient)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateRecipient(recipient);
    }
    ...
    */
    public static com.wcs.newsletter.model.Recipient updateRecipient(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateRecipient(recipient, merge);
    }
    ...
    */
    ...
    public static RecipientLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    RecipientLocalService.class.getName());

            if (invokableLocalService instanceof RecipientLocalService) {
                _service = (RecipientLocalService) invokableLocalService;
            } else {
                _service = new RecipientLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(RecipientLocalServiceUtil.class,
                "_service");
        }
     ...
     * @deprecated
     */
    public void setService(RecipientLocalService service) {
    }
}
