...
public class WcsRegistrationAction implements ModelListener {
    ...
    public void onAfterCreate(Object model) throws ModelListenerException {
        ...
        System.out.println("EZ AZ ÚÚJ = " + mdlObj);
        System.out.println("WcsRegisterAction onAfterCreate mdlObj = " + mdlObj);
        System.out.println("Email cime = " + mdlObj.getEmailAddress());
        try {
